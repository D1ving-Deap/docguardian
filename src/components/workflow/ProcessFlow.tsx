...
// Create subcomponents for each step card
const StepCard = ({ 
  step, 
  title, 
  icon, 
    ...
    <Card className={cn(
      ...
      <CardContent className="p-0 flex flex-col md:flex-row h-full">
        <div className="w-full md:w-1/4 bg-blue-50 flex flex-col items-center justify-center py-5 md:h-full">
          <div className={`w-14 h-14 ${iconBgColor} rounded-full flex items-center justify-center mb-2`}>
            {icon}
          </div>
          <h3 className="text-lg font-bold text-center px-2">{step}. {title}</h3>
        </div>
    ...
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-11 gap-3 mb-6">
        ...
        <StepCard 
          ...
          icon={<Upload className="text-primary w-7 h-7" />}
          iconBgColor="bg-blue-100"
          isActive={processingResult !== null}
        >
        ...
        <StepCard 
          step={2} 
          title="AI Analysis"
          icon={<Sparkles className="text-primary w-7 h-7" />}
          iconBgColor="bg-blue-100"
          isActive={processingResult && processingResult.text ? true : false}
        >
          <p className="text-gray-700 mb-4 text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-11 gap-3">
        ...
        <StepCard 
          ...
          iconBgColor="bg-blue-100"
          isActive={processingResult && processingResult.issues ? true : false}
        >
          <p className="text-gray-700 mb-4 text-sm">
        ...
        <StepCard 
          ...
          icon={<FileCheck className="text-green-600 w-7 h-7" />}
          iconBgColor="bg-blue-100"
          isActive={processingResult ? true : false}
        >
          <p className="text-gray-700 mb-4 text-sm">
